 ...
 * Modified By: SeyedAlireza SanaeeKohroudi <sarsanaee@comp.iust.ac.ir>
 */
#include "ns3/log.h"
...
void
TcpClient::SetRemote (Address peerAddress, uint16_t port)
{
  NS_LOG_FUNCTION (this);
...
void
TcpClient::SetInterval(Time interval)
{
  m_interval = interval;
}
...
TcpClient::Send (void)
{
  ...
  int sendStatus = m_socket->Send (p);
